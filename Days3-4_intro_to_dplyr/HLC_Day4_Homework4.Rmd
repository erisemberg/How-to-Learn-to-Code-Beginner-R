...
* Hint: The total number of individuals is just the number of observations in each group, the total number of species is the sum of `speciestotal` for each group.
