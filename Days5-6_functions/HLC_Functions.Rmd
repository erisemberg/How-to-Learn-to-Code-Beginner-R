...
The condition following the `if` statement is a condition that evaluates to a `boolean` value (either TRUE or FALSE). So you could equivalently use this code: 
...
And if the condition is FALSE, R does nothing:
